                        ...
                        <div class="weblizar-fb-eapps-facebook-feed-item-author-info">
						 <!-- post author name  -->
						  <div class="weblizar-fb-eapps-facebook-feed-item-author-name">
						   ...
						   <!-- post create date  -->
						 <div class="weblizar-fb-eapps-facebook-feed-item-date"><i class="fa fa-clock-o"></i>&nbsp <span><?php printf( _x( '%s Ago', '%s = human-readable time difference', WEBLIZAR_FACEBOOK_TEXT_DOMAIN), human_time_diff( date( 'U', $s), current_time( 'timestamp' ) ) ); ?></span></div>
					   </div>
                    </div>
			  <?php }  
     			  if($feed_type =='post') 

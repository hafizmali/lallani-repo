...
$sqlIMG="select image from llImage where imageID=$imageID";
...
$sql="DELETE from llImage where imageID=$imageID";
//	echo "<br />sqlDEL: ".$sql;
mysql_query($sql);
...
//	echo "<br>file folder: ".$folder.$file;
    unlink($folder.$file);
mysql_close();
echo "<script type='text/javascript'>window.location.href = 'http://lalanii.com/includes/imagemanager.php';</script>";
?>
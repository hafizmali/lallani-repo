...
<div id="portalContent">
	...
	<form class="" accept-charset="UTF-8" name="formBLG" id="formBLG" method="post" action="../process/addupdateblog.php">
		...
		$blog_mpurl=mysql_result($resultBLG,0,"blog_mpurl");	
	...
	$notebook_allow=mysql_result($resultBLG,0,"notebook_allow");
		
		$reco_posts = mysql_result($resultBLG,0,"reco_posts");
		$reco_posts = explode(',',$reco_posts);
		...
		<ul class="blogForm visibleForm">
                ...
                <li class="blogFormLabel">Mp3 File Upload:</li>
				<li class="blogFormBody">
					<input type="file" name="blog_mpurl" id=""  >	
					<?php echo $blog_mpurl; ?>				
				</li>
               ...
               <!-- <li class="blogFormLabel">&nbsp;</li>
				...
				<li class="blogFormBody">
					<input class="nin" type="color" placeholder="Color" name="blog_bg_color" value="<?php echo $blog_bg_color; ?>"><input type="checkbox" value='1' name="bg_allow" id="bg_allow" > Enable Color to Use
				</li>
<li class="blogFormLabel">Notebook Background:</li>
				<li class="blogFormBody">
					<input type="checkbox" value='1' <?php if($notebook_allow == 1){ ?>checked<?php } ?> name="notebook_allow" id="notebook_allow" > Enable Notebook
				</li>
...
?>
<label class="lbladds">Recommended Post Section</label><br /><br />

<span style="float:left;line-height: 22px;"><b>Post 1:</b></span>
<select name="reco_posts1" style="float: left;margin: 0px 10px;width: 230px;">
...
{
?>
<option <?php if($reco_posts[0] == $cr_q_res['blogID']){ ?>selected<?php } ?> value="<?php echo $cr_q_res['blogID']; ?>"><?php echo $cr_q_res['blogTitle']; ?></option>
<?php } ?>
</select>


<span style="float:left;line-height: 22px;"><b>Post 2:</b></span>
<select name="reco_posts2" style="float: left;margin: 0px 10px;width: 230px;">
<option value="0">-- Select Post --</option>
<?php 
$cr_query = mysql_query("Select * from llBlog");
while($cr_q_res = mysql_fetch_array($cr_query))
{
?>
<option <?php if($reco_posts[1] == $cr_q_res['blogID']){ ?>selected<?php } ?> value="<?php echo $cr_q_res['blogID']; ?>"><?php echo $cr_q_res['blogTitle']; ?></option>
<?php } ?>
</select>
<br /><br />
<span style="float:left;line-height: 22px;"><b>Post 3:</b></span>
<select name="reco_posts3" style="float: left;margin: 0px 10px;width: 230px;">
<option value="0">-- Select Post --</option>
<?php 
$cr_query = mysql_query("Select * from llBlog");
while($cr_q_res = mysql_fetch_array($cr_query))
{
?>
<option <?php if($reco_posts[2] == $cr_q_res['blogID']){ ?>selected<?php } ?> value="<?php echo $cr_q_res['blogID']; ?>"><?php echo $cr_q_res['blogTitle']; ?></option>
<?php } ?>
</select>

<span style="float:left;line-height: 22px;"><b>Post 4:</b></span>
<select name="reco_posts4" style="float: left;margin: 0px 10px;width: 230px;">
<option value="0">-- Select Post --</option>
<?php 
$cr_query = mysql_query("Select * from llBlog");
while($cr_q_res = mysql_fetch_array($cr_query))
{
?>
<option <?php if($reco_posts[3] == $cr_q_res['blogID']){ ?>selected<?php } ?> value="<?php echo $cr_q_res['blogID']; ?>"><?php echo $cr_q_res['blogTitle']; ?></option>
<?php } ?>
</select>

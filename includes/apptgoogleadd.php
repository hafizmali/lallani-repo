...
$hour=$_GET['hour'];
	...
	$message .= '<p>Aloha '.$firstname.' '.$lastname.',</p>';
	$message .= '<p>You have a new appointment request from Lalanii.com<br><a href="http://lalanii.com/process/apptapprove.php?date='.$date.'&hour='.$hour.'">accept and add meeting to Lalanii.com database</a><br></p>';    
	$message .= '<p>Date: '.date("m/d/Y",strtotime($date)).'</p>';    
	$message .= '<p>Time: '.$hour.'</p>';
	$message .= '<p>Requested By: '.$_SESSION['userFirstName'].'</p>';
	$message .= "</body>\n";
	$message .= "</html>\n";
	$message .= "--$mime_boundary\n";
...
echo "<script type='text/javascript'>window.location.href = 'http://lalanii.com/hireme/appointment.php?message=requested';</script>";
?>